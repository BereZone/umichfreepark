 ...
 * WHY OSM AT ALL
 *
 * UMichFreePark's own data files carry hand-verified enforcement rules, but they don't
...
// (thousands of features for a handful of structures) and not what UMichFreePark draws.
...
const REQUEST_HEADERS = { 'User-Agent': 'umichfreepark-osm-parking-fetch/1.0', Accept: '*/*' };
